# Plan: Short epic name

Component: impacted component (for example, an NPM workspace package, Cargo workspace crate or submodule).
...
<!-- ONLY IF USER INTERACTION IS PART OF THE EPIC. -->

## User Flow

Outline the different user flows.

### Page Layout

ASCII wireframes of newly added pages.

---

## Tech Specs

This section should outline technical details, such as new routes, components, environment variables, test cases and data sources.
...
A list of open questions and assumptions that are important to know about.
